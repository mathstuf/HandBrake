...
#define HB_VCODEC_MASK        0x03FFFFFF
...
#define HB_VCODEC_FFMPEG_VAAPI_H264 0x01000000
#define HB_VCODEC_FFMPEG_VAAPI_H265 0x02000000
#define HB_VCODEC_FFMPEG_MASK  (0x00000F0|HB_VCODEC_FFMPEG_VCE_H264|HB_VCODEC_FFMPEG_VCE_H265|HB_VCODEC_FFMPEG_NVENC_H264|HB_VCODEC_FFMPEG_NVENC_H265|HB_VCODEC_FFMPEG_VT_H264|HB_VCODEC_FFMPEG_VT_H265|HB_VCODEC_FFMPEG_VAAPI_H264|HB_VCODEC_FFMPEG_VAAPI_H265)
...
enum
{
    ...
    HB_FILTER_QSV_POST,
    // for VAAPI - important to have as a last one
    HB_FILTER_VAAPI_HWUPLOAD,
